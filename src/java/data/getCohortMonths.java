    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            loadcohort lc = new loadcohort();
                    ...
                    + "<li class='nav-item btn btn-primary p-0  mr-1 mb-1' data-cohortmonth='3m'><a class='nav-link' onclick(loadcohorts();hiddenelements();isdisplayindicators();) data-toggle='tab' data-target='#nav-3months'><span class='hidden_id' data-mn='3m'>3m. Cohort (" + lc.getpreviousmonth(new Integer(year), new Integer(monthstring), -3) +")</span></a></li>"
                   + "<li class='nav-item btn btn-primary  p-0  mr-1 mb-1' data-cohortmonth='6m'><a class='nav-link' onclick(loadcohorts();hiddenelements();isdisplayindicators();) data-toggle='tab' data-target='#nav-6months'><span class='hidden_id' data-mn='6m' >6m. Cohort (" + lc.getpreviousmonth(new Integer(year), new Integer(monthstring), -6) +")</span></a></li>"
