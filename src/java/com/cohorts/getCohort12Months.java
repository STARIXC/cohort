 ...
 * @author HSDSA
 */
public class getCohort12Months extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            loadcohort lc = new loadcohort();
                    ...
                    data = "<input type='text' readonly data-cohortmonth='12m' onchange(loadcohorts();hiddenelements();isdisplayindicators();) value='12m. Cohort (" + lc.getpreviousmonth(new Integer(year), new Integer(monthstring), -12) +")'/>";
