 ...
 * @author HSDSA
 */
public class getCohort3Months extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            loadcohort lc = new loadcohort();
                    ...
                    data = "<input type='text' readonly data-cohortmonth='3m' onchange(loadcohorts();hiddenelements();isdisplayindicators();) value='3m. Cohort (" + lc.getpreviousmonth(new Integer(year), new Integer(monthstring), -3) +")'/>";
