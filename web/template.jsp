                                        ...
                                        <div class="row offset-0 p-2">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select  required="true"  onchange="loadctype();cohortmonths();"name="cohortttypemain" id="cohortttypemain" class="form-control" >
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select required="true"    name="montht" id="montht" onchange="cohortmonths();" class="form-control" >
